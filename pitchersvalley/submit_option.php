...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($selectedOption !== null) {
        ...
        $checkQuery = "SELECT pitch$buttonNo FROM pitchers_valley";
        ...
        if ($checkResult) {
            ...
            $updateQuery = "UPDATE pitchers_valley SET total_points = total_points + 5 WHERE pitch$buttonNo = '$selectedOption'";
