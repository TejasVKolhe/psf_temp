...
$checkUsernameQuery = "SELECT username FROM pitchers_valley WHERE username = '$username'";
...
$sql = "INSERT INTO pitchers_valley (fullname, username, contact, password, email) 
