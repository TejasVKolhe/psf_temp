...
background: linear-gradient(90deg, rgba(226,224,236,1) 0%, rgba(79,153,219,1) 54%);
        }
    ...
    #question{
        font-size: 3vw; font-family: 'Inknut Antiqua', serif;
    }
...
<body>
    ...
    <main class="relative min-h-screen flex flex-col justify-center bg-slate-900 overflow-hidden">
        ...
        <div class="box-lid" id="content">
            ...
            <button id="vote" class="bubbly-button" style="">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (!isNaN(response.end_time)) {
                        ...
                        // Display an alert
                        alert("Invalid end time received from the server");
                        console.log("reach");
                        // Redirect to the specified page (index.html in this case)
                        console.log("reached");
                    }

        //             else {
        //                 // console.error('Invalid end time received from the server:', response);
        //                 // header("Location: https://www.punestartupfest.in/LP/leaderboard.php");
        // // Display an alert and then redirect
        // echo '<script type="text/javascript">alert("nvalid end time received from the server");';
